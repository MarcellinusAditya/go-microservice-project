...
//mencegah force shutdown app ketika terdapat error panic
//dengan recover
...
//membatasi request yang masuk
//jika request terlalu banyak akan menampilkan error
...
//melakukan ekstract token dari header authorization
...
//validasi api key dengan membandingkan validate key dengan api key
...
//validasi bearer token dengan mengecek apakah token masih valid
//jika valid, menyimpan data user ke context
...
//middleware auth yang disisipikan pada router
