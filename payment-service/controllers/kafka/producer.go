...
func (k *Kafka) ProduceMessage(topic string, data []byte) error {
	...
	config.Producer.Return.Successes = true//mengembalikan status akses setelah pesan dikirim

	config.Producer.RequiredAcks = sarama.WaitForAll//memastikan seluruh broker yang relevan tersedia
